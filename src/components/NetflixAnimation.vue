<!--
 I have this splash screen to keep the user entertained while content is loading.
 The markup and animation is based on
 Codepen https://codepen.io/claudio_bonfati/pen/mdryxPv
-->
...
const showSplashScreen = !showsStore.shows.currentPage;

/**
 * Change this to 'E', 'T', 'F', 'L', 'I', or 'X' as needed
 */
const currentLetter = ref('N');
</script>

<template>
  <div id="container" v-if="showSplashScreen">
    <netflixintro :letter="currentLetter">
      <div class="helper-1">
...
#container {
  ...
  left: 0;
  z-index: 200;
  animation: hideSplash 0.3s ease-out 5s forwards;
}
